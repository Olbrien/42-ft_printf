...
/*   Updated: 2021/02/15 13:45:20 by tisantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
							...
							char *decimal_string, t_slist *slist, double n)
{
	...
	if (slist->precision < 0)
		...
		decimal_string = finalize_decimal_with_precision_e(decimal_string, slist);
...
int			check_bankers_round_e(double n, t_slist *slist)
{
	double		temp;
	long long	integer;
...
double		check_precision_condition_e(double n, t_slist *slist)
{
	long double	temp;
...
long long	get_decimal_number_unsigned_e(double n, t_slist *slist,
