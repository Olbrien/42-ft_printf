...
/*   Updated: 2021/02/15 13:43:24 by tisantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_printf.h"

static long long	get_decimal_number_signed_e(double n,
...
static long long	get_integer_number_e(double n, t_slist *slist)
{
	double	temp;
...
static char			*exponent_process(double n, t_slist *slist)
{
