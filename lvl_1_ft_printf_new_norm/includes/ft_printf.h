...
/*   Updated: 2021/02/23 01:38:02 by tisantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			conversion_path_x_lower(t_plist *plist, va_list *args,
					t_slist *slist);
void			conversion_path_x_upper(t_plist *plist, va_list *args,
					t_slist *slist);
void			conversion_path_n(t_plist *plist, va_list *args,
					t_slist *slist);
void			conversion_path_s(t_plist *plist, va_list *args,
					t_slist *slist);
void			conversion_path_c(t_plist *plist, va_list *args,
					t_slist *slist);
...
char			*integer_precision_with_zeros(t_slist *slist, char *string,
					char *send);
void			integer_space(t_plist *plist, t_slist *slist, char *string,
					int length);
...
char			*unsigned_precision_with_zeros(t_slist *slist, char *string,
					char *send);
...
void			hexadecimallower_write(t_plist *plist, char *string,
					t_slist *slist);
char			*hexadecimallower_precision_with_zeros(t_slist *slist,
					char *string, char *send);
char			*return_if_one_hexalowerdigit(t_slist *slist,
					char *send, long long int value);
char			*hexalower_write_zeros2(t_slist *slist, char *send,
					char *string);

void			ifhexadecimallowerhh(t_plist *plist, t_slist *slist,
					va_list *args);
void			ifhexadecimallowerh(t_plist *plist, t_slist *slist,
					va_list *args);
void			ifhexadecimallowerll(t_plist *plist, t_slist *slist,
					va_list *args);
void			ifhexadecimallowerl(t_plist *plist, t_slist *slist,
					va_list *args);

void			ifhexadecimalupper(t_plist *plist, t_slist *slist,
					va_list *args);
...
void			hexadecimalupper_write(t_plist *plist, char *string,
					t_slist *slist);
char			*hexadecimalupper_precision_with_zeros(t_slist *slist,
					char *string, char *send);
char			*return_if_one_hexaupperdigit(t_slist *slist,
					char *send, long long int value);
char			*hexaupper_write_zeros2(t_slist *slist, char *send,
					char *string);

void			ifhexadecimalupperhh(t_plist *plist, t_slist *slist,
					va_list *args);
void			ifhexadecimalupperh(t_plist *plist, t_slist *slist,
					va_list *args);
void			ifhexadecimalupperll(t_plist *plist, t_slist *slist,
					va_list *args);
void			ifhexadecimalupperl(t_plist *plist, t_slist *slist,
					va_list *args);
...
char			*finalize_process(char *integer_string, char *decimal_string,
					t_slist *slist, double n);
char			*finalize_integer(char *integer_string, double n,
					t_slist *slist);
...
void			float_space(t_plist *plist, t_slist *slist, char *string,
					int length);
